    ...
    <div v-if="appointment" class="mt-4 space-y-4">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          ...
          <p class="text-sm font-medium text-primary-600">{{ settingsStore.formatPrice(appointment.booked_price || 0, appointment.booked_price_currency || appointment.services?.price_currency) }}</p>
        </div>
        <div>

...
<template>
  <div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
      <div>
        <h1 class="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Platform Overview</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mt-6 lg:mt-10">
       <div class="lg:col-span-2 bg-white rounded-2xl border border-slate-200 p-4 md:p-8">
       ...
       <div class="bg-indigo-900 rounded-2xl p-4 md:p-8 text-white">

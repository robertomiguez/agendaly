...
- **Business Information:** Business name, description, logo
- **Service Information:** Services offered, pricing, availability
- **Location Data:** Business addresses
- **Staff Information:** Staff names, roles, schedules

---

## C. LEGAL BASES FOR PROCESSING (GDPR Article 6)
...
- **Operate the Platform:** Enable account creation, login, and core functionality
- **Facilitate Bookings:** Connect customers with Providers and manage appointments
- **Provide Support:** Respond to inquiries and resolve issues
- **Improve Services:** Analyze usage patterns, test new features, enhance user experience
...
Providers are **independent Data Controllers** for personal data they collect through services they provide. We are not responsible for how Providers handle your data outside the Platform.
...
- Notify us and affected individuals of data breaches

**You are solely responsible for your compliance with data protection laws.**

---

## N. UPDATES TO THIS POLICY

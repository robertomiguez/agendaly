...
- All services are provided **solely** by independent Providers

### 2. Bookings

- Bookings create a direct contractual relationship between you and the Provider
...
**TO THE MAXIMUM EXTENT PERMITTED BY LAW, THE PLATFORM AND ITS OPERATORS DISCLAIM ALL LIABILITY FOR:**

- Poor service quality, dissatisfaction, or unmet expectations
- Injuries, allergic reactions, adverse effects, or health complications
- Property damage, theft, or financial loss
- Misconduct, negligence, fraud, or criminal acts by Providers
- Data breaches or unauthorized access originating from Provider systems
...
You agree to defend, indemnify, and hold harmless the Platform, its operators, affiliates, officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from:
...
We reserve the right to suspend or terminate your access to the Platform at any time, with or without notice, if:
...
- Any form of control or direction over your business operations

### 11. Provider Obligations

By using the Platform as a Provider, you represent and warrant that:

- You hold all required licenses, permits, certifications, and insurance
- You comply with all applicable laws, including:
  - **GDPR** (if serving EU customers)
  - **LGPD** (if serving Brazilian customers)
  - **CCPA** (if serving California residents)
  - **PIPEDA** (if operating in Canada)
  - Local health, safety, and professional regulations
- You maintain appropriate liability and professional insurance
- You comply with all tax obligations in your jurisdiction
- All information you provide about your services is accurate and lawful

### 12. Full Responsibility

You are **solely and exclusively responsible** for:

- The services you provide and their quality
- Customer interactions and satisfaction
- Outcomes, results, safety, and any adverse effects
- Pricing, refund policies, and cancellation terms
- Handling customer data in compliance with privacy laws
- Your own business operations, employees, and contractors

### 13. Provider Indemnification

You agree to defend, indemnify, and hold harmless the Platform, its operators, affiliates, officers, directors, employees, and agents from any and all claims, damages, losses, liabilities, fines, penalties, and expenses (including reasonable legal fees) arising from:

- Services you provide or fail to provide
- Injuries, damages, or losses suffered by customers
- Your violation of any law or regulation
- Inaccurate, misleading, or unlawful information you provide
- Customer complaints, disputes, or legal actions
- Data breaches or privacy violations related to your handling of customer data
- Your violation of these Terms

### 14. Content and Listings

- You are responsible for all content you publish, including descriptions, images, prices, and claims
- We do **not** verify, validate, or guarantee the accuracy of your content
- You grant us a non-exclusive, worldwide, royalty-free license to display your content on the Platform
- You must not post illegal, defamatory, or infringing content

### 15. Suspension and Removal

We may suspend or remove your account at any time, with or without notice, if:

- You breach these Terms
- Customer complaints suggest safety or quality issues
- You create legal, regulatory, or reputational risk
- We are required to do so by law
- We cease operations
